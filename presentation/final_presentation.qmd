...
::: {style="width:45%"}
<img src="./figure/symptom_diagram.png"  style="position:absolute;text-align:right;float:right;width:60%;margin-left:10%;">
::: 
...
* Informing $\Pr(S_1|\text{untested})$
  * Percentage of population experiencing COVID-19-like symptoms
...
## Incorporating Information on the Asymptomatic Rate 
...
* Proportion of medians contained in the probabilistic bias interval -- Massachusetts and Michigan 
...
## Comparison to Wastewater Data (By County)
...
## County Level for All Counties in Michigan {.scrollable}

## Above/Below for Most Concordant Version (MA)
