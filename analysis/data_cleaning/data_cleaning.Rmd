...
### Hospitalizations
* `hosp_biweekly_all_states.RDS` is biweekly hospitalization by state, accessible [here](https://dev.socrata.com/foundry/healthdata.gov/g62h-syeh)
...
Accessed from the CDC [here](https://data.cdc.gov/Public-Health-Surveillance/United-States-COVID-19-Community-Levels-by-County/3nnm-4jni).
...
test <- httr::GET(URLencode("https://healthdata.gov/resource/g62h-syeh.json?state=MA&$where=date between '2020-12-31T12:00:00' and '2022-02-25T14:00:00'&$select=deaths_covid,date,percent_of_inpatients_with_covid,inpatient_beds_used_covid,inpatient_beds_used,state"))
