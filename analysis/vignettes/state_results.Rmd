...
ggsave(here('presentation/figure/covidestim_concordance_state.jpeg'), height=8, width=10)
...
ggsave(here('presentation/figure/state_level_mi_ma.jpeg'), width =12, height=10)
