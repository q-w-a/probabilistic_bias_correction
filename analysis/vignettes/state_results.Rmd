...
ggsave(here('thesis/figure/variant_prop.jpeg'), width =9, height=4, dpi=400)
...
ggsave(here('thesis/figure/ratio-peak-omicron.jpeg'), height=11, width=12)
...
ggsave(here('thesis/figure/testrate-low-summer.jpeg'), height=6,width=12)
...
ggsave(here('thesis/figure/heatmap_ratio_est_observed.jpeg'),
       height=10,
       width =13,
       dpi=400)
...
ggsave(here('thesis/figure/rank-ratio-over-time.jpeg'), height=8,width=12)
...
ggsave(here::here(paste0('thesis/figure/texas-lag.jpeg')), 
...
ggsave(here('thesis/figure/texas-data-sources.jpeg'),height=5, width=10, dpi=400)
...
ggsave(here('thesis/figure/jhu_cdc_all_states_1.jpeg'), height=25, width=19)



plot_grid(title_row, plot2, rel_heights=c(.05,.95), nrow=2)

ggsave(here('thesis/figure/jhu_cdc_all_states_2.jpeg'), height=25, width=19)
...
# PB Intervals for All States -- Break up into 2 groups
...
ggsave(here('thesis/figure/all-states-first-impl.jpeg'), height=18, width=16)
