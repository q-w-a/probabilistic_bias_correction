...
results_path <- here("analysis/results/adj_biweekly_state_jhu/")

```

```{r correction v1, eval=TRUE}
priors_version <- "v1"
...
ggsave(here('thesis/figure/ctis_beta_states.pdf'), height = 11, width = 16)
...
ggsave(here('thesis/figure/ctis_s_untested_states.pdf'), height =11, width = 16)
