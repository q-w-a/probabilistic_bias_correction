...
```{r, fig.cap = "\\label{fig:trunc}", fig.height = 8}
...
title_gg <- ggplot() + 
  ...
  theme(plot.title=element_text(face="bold", hjust = .5, size = 16, margin =margin(5,0,2,0)))
...
```{r, fig.cap = "\\label{fig:comp-beta}", fig.height =10}
