...
\caption{\label{fig:theta}}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{\label{fig:prior-induced}}\label{fig:unnamed-chunk-8}
\end{figure}
\newpage
...
\caption{\label{fig:melded}}\label{fig:unnamed-chunk-10}
\end{figure}
...
~~~The Sampling-Importance-Resampling Algorithm, introduced in (\textbf{rubin1987?}), is a non-iterative method for approximating a sample from a target probability density function \(f\).
...
\caption{\label{fig:ex1}}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption{\label{fig:ex12}}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption{\label{fig:ex2}}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{\label{fig:ex22}}\label{fig:unnamed-chunk-14}
\end{figure}
\newpage
...
As outlined in (\textbf{carvalho2023?}), we can formally define logarithmic pooling as follows.
...
\caption{\label{fig:loess}}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{\label{fig:smooth-spans}}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{\label{fig:weights} The only values with nonzero weights are those within the interval $(500 - \alpha (n), 500 - \alpha (n))$. That is, the proportion $\alpha$ of the data points closest to $x^*$ will have nonzero weights.}\label{fig:unnamed-chunk-18}
\end{figure}
\newpage
...
\caption{\label{fig:ex-poly}}\label{fig:unnamed-chunk-19}
\end{figure}
\end{flushleft}
