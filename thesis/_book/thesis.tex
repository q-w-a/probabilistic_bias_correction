...
{\centering \includegraphics[width=0.96\linewidth]{thesis_files/figure-latex/unnamed-chunk-3-1} \includegraphics[width=0.96\linewidth]{thesis_files/figure-latex/unnamed-chunk-3-2} \includegraphics[width=0.96\linewidth]{thesis_files/figure-latex/unnamed-chunk-3-3} \includegraphics[width=0.96\linewidth]{thesis_files/figure-latex/unnamed-chunk-3-4} \includegraphics[width=0.96\linewidth]{thesis_files/figure-latex/unnamed-chunk-3-5} 

}

\caption{\label{fig:simmvn}}\label{fig:unnamed-chunk-3}
\end{figure}
