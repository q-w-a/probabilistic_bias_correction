...
## Relationship Between $(X+Y)_\alpha$ and $X_{alpha}$ +$Y_{\alpha}$ for Dependent Variables $X,Y$
...
### Derivation of the Distribution of X+Y for Bivariate Normal {#conservativeintervals}
