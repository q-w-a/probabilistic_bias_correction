...
The peak in July corresponds to the Delta wave, where the more transmissible B.1.617.2 (delta) variant of concern displaced the previously dominant B.1.351 (alpha) variant [@delrio2021]. The peak in December corresponds to the Omicron wave.



```{r, out.width = "100%", fig.cap = "\\label{fig:michigan-variant}Presenting the probabilistic intervals along with the variant proportions for variants designated as Variant of Interest or Variant of Concern by the World Health Organization. We see the rise in Omicron clearly in the probabilistic bias interva"}
