...
The test specificity $P(test -| -)$ is defined as $P(test -|- )\sim TBeta(a = 4998.50, \beta = 	0.25)$, bounded between 0.9998 and 1 and with mean $\dfrac{a}{a + b} = 0.99995$. The high certainty for this parameter is based on the [CDC 2019-nCoV Real-Time RT-PCR Diagnostic Panel](https://www.fda.gov/media/134922/download). 
